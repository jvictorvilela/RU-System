...
<html>
    <jsp:include page="layout/header.jsp" >
        <jsp:param name="title" value="Tela nutricionista" />
    </jsp:include>

    <jsp:include page="autenticarNutricionista.jsp" />
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-admin">
                                <div class="box-titulo"><i class="fas fa-plus-circle"></i>Criar cardapio da semana</div>
                                <div class="box-conteudo">
                                    <form action="/ru/Controller?command=AdicionarFichas" method="POST">
                                        <div class="form-group">
                                            <label for="segundaLabel">Segunda-Feira</label>
                                            <select id="segundaLabel" class="form-control">
                                              <option selected>Cardapio 01</option>
                                              <option>Cardapio 02</option>
                                              <option>Cardapio 03</option>
                                              <option>Cardapio 04</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
