...
<div class="top-responsivo">
    <div class="collapse" id="navbarToggleExternalContent">
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link active" href="usuario.jsp"><i class="fas fa-home nav-left-icon"></i> Inicio</a>
            </li>
            <div class="separador-menu-responsivo"></div>
            <li class="nav-item">
                <a class="nav-link" href="editarPerfil.jsp"><i class="fas fa-user nav-left-icon"></i> Editar perfil</a>
            </li>
            <li class="nav-item">
